...
{
    return createTree(0, TYPE_BOOL, NODE_REPEAT, NULL,
                      cond, NULL, body);
}

tnode* makeDoWhileNode(tnode *body, tnode *cond)
{
    return createTree(0, TYPE_BOOL, NODE_DOWHILE, NULL,
                      cond, NULL, body);
}
...
void printTree(tnode *t)
{
    ...
    switch (t->nodetype)
    {
        ...
        case NODE_REPEAT:    printf("REPEAT "); break;
        case NODE_DOWHILE:   printf("DO-WHILE "); break;
    }
